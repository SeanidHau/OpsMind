    ...
    def __init__(
        ...
        *,
        ...
        if stop_after_stalls < replan_after_stalls:
            raise ValueError("stop_after_stalls must lower than replan_after_stalls")
